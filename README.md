...
<h2 align="center">A Data Scientist, Software Developer and a Certified Google Cloud Engineer using Python and its packages like Django, Wagtail, FastAPI, Pandas, Streamlit & Pytorch</h2>
<h3 align="center">In <strong>Artificial Intelligence</strong> space I specialize in Generative AI utilizing various tools like <strong>LangChain, Llama Index and FastAPI </strong> to create autonomous agents</h3>
